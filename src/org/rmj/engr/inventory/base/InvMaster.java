...
public class InvMaster {
    ...
    public InvMaster(GRider foGRider, String fsBranchCD, String fsProjctCd, boolean fbWithParent){
        this.poGRider = foGRider;
        
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            this.psProjctCd = fsProjctCd;
    ...
    public boolean NewRecord(){
        ...
        poData.setBranchCd(psProjctCd.isEmpty() ? psBranchCd : psProjctCd);
    ...
    public boolean SaveRecord(){
        ...
        if(poGRider.executeQuery(lsSQL, loNewEnt.getTable(), poGRider.getBranchCode(), "") == 0){
