 ...
 * @since 2018-11-09
 */
package org.rmj.engr.inventory.base.views;
...
public class SubUnitController implements Initializable {
    ...
    public void cmdButton_Click(ActionEvent event) {
     ...
     private void initGridLedger(){
        ...
        index01.setCellValueFactory(new PropertyValueFactory<org.rmj.engr.inventory.base.views.TableModel,String>("index01"));
        index02.setCellValueFactory(new PropertyValueFactory<org.rmj.engr.inventory.base.views.TableModel,String>("index02"));
        index03.setCellValueFactory(new PropertyValueFactory<org.rmj.engr.inventory.base.views.TableModel,String>("index03"));
        index04.setCellValueFactory(new PropertyValueFactory<org.rmj.engr.inventory.base.views.TableModel,String>("index04"));
        index05.setCellValueFactory(new PropertyValueFactory<org.rmj.engr.inventory.base.views.TableModel,String>("index05"));
        index06.setCellValueFactory(new PropertyValueFactory<org.rmj.engr.inventory.base.views.TableModel,String>("index06"));
        index07.setCellValueFactory(new PropertyValueFactory<org.rmj.engr.inventory.base.views.TableModel,String>("index07"));
