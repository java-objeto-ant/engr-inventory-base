...
import org.rmj.engr.inventory.pojo.UnitInvSubUnit;
...
public class Inventory{   
    ...
    public Inventory(GRider foGRider, String fsBranchCD, String fsProjctCd, boolean fbWithParent){
        poGRider = foGRider;
        
        if (foGRider != null){
            pbWithParent = fbWithParent;
            psBranchCd = fsBranchCD;
            psProjctCd = fsProjctCd;
    ...
    private boolean isEntryOK(UnitInventory foNewEnt){
        ...
        if (foNewEnt.getBarCodex().length() > 12){
